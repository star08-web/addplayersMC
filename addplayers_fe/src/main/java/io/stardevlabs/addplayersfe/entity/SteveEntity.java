...
package io.stardevlabs.addplayersfe.entity;
...
public class SteveEntity extends Monster {
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new RemoveBlockGoal(Blocks.GRASS_BLOCK, this, 1, (int) 3));
		this.goalSelector.addGoal(2, new RemoveBlockGoal(Blocks.DIRT, this, 1, (int) 3));
		this.goalSelector.addGoal(3, new RemoveBlockGoal(Blocks.STONE, this, 1, (int) 3));
		this.goalSelector.addGoal(4, new RemoveBlockGoal(Blocks.GRAVEL, this, 1, (int) 3));
	...
	public static void init() {
		BiomeModifications.create(new ResourceLocation(AddplayersFeMod.MODID, "steve_entity_spawn")).add(ModificationPhase.ADDITIONS,
				BiomeSelectors.all(), ctx -> ctx.getSpawnSettings().addSpawn(MobCategory.MONSTER,
						new MobSpawnSettings.SpawnerData(AddplayersFeModEntities.STEVE, 20, 4, 4)));
	}
